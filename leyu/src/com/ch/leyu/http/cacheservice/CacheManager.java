...
public class CacheManager {
    ...
    public void updateCache(ServerDataCache serverDataCache) {
        SQLiteDatabase db = mCacheDatabaseHelper.getWritableDatabase();
        db.execSQL("update "+CacheTable.TABLE_NAME+" set  "+CacheTable.DATA+" = ? , "+CacheTable.TIME+" = ? where "+CacheTable.URL+" = ?", new Object[] { serverDataCache.getServerData(), serverDataCache.getTime(), serverDataCache.getUrl() });
        db.close();
    }
