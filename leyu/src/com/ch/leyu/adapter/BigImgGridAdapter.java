 ...
 */
public class BigImgGridAdapter extends BaseAdapter {

    private ArrayList<Property> mNewsList;

    private Context mContext;

    public BigImgGridAdapter(ArrayList<Property> mNewsList, Context mContext) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.img.setLayoutParams(new RelativeLayout.LayoutParams(CommonUtil
                .getWidthMetrics(mContext) / 2, (int) (CommonUtil.getWidthMetrics(mContext) / 1.5)));
