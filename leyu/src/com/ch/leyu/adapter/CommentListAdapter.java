...
import com.ch.leyu.html.URLImageGetter;
...
public class CommentListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.detail = (TextView) convertView.findViewById(R.id.comment_list_web_detail);
...
//        holder.detail.loadDataWithBaseURL("", mArrayList.get(position).getComment(), "text/html","UTF-8", "");
        
        Spanned text = Html.fromHtml(mArrayList.get(position).getComment(),new URLImageGetter(mContext, holder.detail),null);
