...
//               manager.beginTransaction().add(R.id.fragment_content, detailFragment, "detailFragment").addToBackStack(null).hide(HSNewsFragment.this).commit();
               CommonUtil.switchToFragment(getActivity(), R.id.fragment_content, detailFragment, "detailFragment");
           }
    }
